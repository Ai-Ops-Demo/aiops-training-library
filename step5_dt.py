...
dt = DigitalTwin(dt_modelname = dt_modelname,data_dir=data_dir,
				num_val_sets=6,independantVars=independantVars,
				dependantVar=dependantVar,dt_lookback=dt_lookback,
                velocity=False,scanrate=scanrate)
			
dt.trainDt(gru1_dims=12,gru2_dims=12,lr=.001,ep=100,batch_size = 5000)
